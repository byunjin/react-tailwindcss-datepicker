...
const ToggleButton = (e) => {
    return e.isEmpty ? React__default["default"].createElement(DateIcon, { className: "h-5 w-5" }) : React__default["default"].createElement(DateIcon, { className: "h-5 w-5" }); //<CloseIcon className="h-5 w-5" />;
};
