...
export const Arrow = React.forwardRef<HTMLDivElement, {}>((props, ref) => {
    return (
        <div
            ref={ref}
            className="absolute z-20 h-3 w-3 rotate-45 mt-0.5 ml-[1.2rem] border-l border-t border-transparent bg-transparent dark:bg-transparent dark:border-transparent"
        />
    );
});
